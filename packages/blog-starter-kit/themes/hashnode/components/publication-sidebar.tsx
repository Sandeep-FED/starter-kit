...
import {
	blurActiveFocus,
	doesPublicationHaveSocialLinks,
...
type Props = {
	publication: Pick<
		PublicationFragment,
		'id' | 'title' | 'isTeam' | 'links' | 'author' | 'preferences'
	>;
	toggleSidebar: () => void;
	isHome?: boolean | null;
		...
		<DialogPrimitive.Root open>
			<DialogPrimitive.Portal>
				...
				>
					...
					>
						<div
							className={twJoin('flex items-center justify-between pl-8 pr-4', 'dark:text-white')}
						>
							<PublicationLogo
